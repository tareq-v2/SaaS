                ...
                <nav class="nav flex-column">
                    ...
                    <div class="nav-item">
                        ...
                        <div class="collapse" id="userManagement">
                            <a class="nav-link text-light ps-4" href="{{ route('admin.users.import.form') }}">
                                <i class="fas fa-list me-2"></i>Import Users
                            </a>
        ...
        <div class="col-md-9 col-lg-10">
            ...
            <div class="bg-white shadow-sm mb-4">
                <div class="d-flex justify-content-between align-items-center p-3">
                    <div>
                        ...
                        <small class="text-muted">Welcome, {{ Auth::user()->name }}! You have administrative privileges.</small>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <button class="btn btn-warning btn-sm" onclick="toggleFullscreen()">
            ...
            <div class="px-3">
                ...
                <div class="alert alert-info shadow-sm mb-4">
                    ...
                    <strong>Welcome, Admin!</strong> You have administrative privileges and can manage all aspects of the system.
                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Manage regular users and their permissions</p>
                                    </div>
                                </div>
                                <p class="card-text">Control user accounts, roles, and access permissions. View user activity and manage account statuses.</p>
                                <div class="d-flex gap-2">
                                    <button class="btn btn-primary" onclick="quickAction('manage-users')">
                                        <i class="fas fa-users me-1"></i>Manage Users
                                    </button>
                                    <button class="btn btn-outline-primary btn-sm" onclick="quickAction('add-user')">
                                ...
                                <div class="timeline">
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content">
                                            <h6 class="timeline-title">User Management Action</h6>
                                            <p class="timeline-text text-muted">New user account created successfully</p>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content">
                                            <h6 class="timeline-title">Content Updated</h6>
                                            <p class="timeline-text text-muted">Website content was modified</p>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-content">
                                            <h6 class="timeline-title">System Settings</h6>
                                            <p class="timeline-text text-muted">Configuration settings updated</p>
...
<script>
    function quickAction(action) {
        switch(action) {
            case 'add-user':
            case 'manage-users':
                alert('User Management action clicked! Add your route here.');
                break;
            case 'manage-content':
            case 'add-post':
                alert('Content Management action clicked! Add your route here.');
                break;
            case 'backup':
